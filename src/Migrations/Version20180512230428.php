 ...
 */
final class Version20180512230428 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE beer (id INT AUTO_INCREMENT NOT NULL, brewery_id INT DEFAULT NULL, category_id INT DEFAULT NULL, style_id INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, abv DOUBLE PRECISION NOT NULL, ibu DOUBLE PRECISION NOT NULL, srm DOUBLE PRECISION NOT NULL, upc VARCHAR(12) NOT NULL, description LONGTEXT DEFAULT NULL, last_modification DATETIME NOT NULL, INDEX IDX_58F666ADD15C960 (brewery_id), INDEX IDX_58F666AD12469DE2 (category_id), INDEX IDX_58F666ADBACD6074 (style_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE brewery (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, address1 VARCHAR(255) DEFAULT NULL, address2 VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, state VARCHAR(255) NOT NULL, code VARCHAR(10) NOT NULL, country VARCHAR(50) NOT NULL, phone VARCHAR(50) NOT NULL, website VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, last_modification DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, last_modification DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE geocode (id INT AUTO_INCREMENT NOT NULL, brewery_id INT DEFAULT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, accuracy VARCHAR(255) NOT NULL, INDEX IDX_C6773CE4D15C960 (brewery_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE style (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, last_modification DATETIME NOT NULL, INDEX IDX_33BDB86A12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
